...
exports.CHORD_TYPE_LEGENDS = exports.COMMON_PROGRESSIONS = exports.DEGREE_NAMES = exports.ROMAN_NUMERALS = exports.CHORD_MAPS = exports.ALL_KEYS = exports.SIMPLE_KEYS = void 0;
// 简化的调性列表（用于快速选择）
exports.SIMPLE_KEYS = ['C', 'D', 'E', 'F', 'G', 'A', 'B'];
// 完整的调性列表（包含升降号）
exports.ALL_KEYS = [
    'C', 'C#', 'Db', 'D', 'D#', 'Eb', 'E', 'F',
...
// 级数名称
exports.DEGREE_NAMES = ['一度', '二度', '三度', '四度', '五度', '六度', '七度'];
// 常用和弦进行
exports.COMMON_PROGRESSIONS = [
...
//# sourceMappingURL=chord-data.js.map